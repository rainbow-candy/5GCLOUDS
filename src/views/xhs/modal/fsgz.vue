<template>
  <div>
    <el-form
      ...
      class="ruleForm"
    >
      <el-form-item label="搜素快手ID号：" prop="search_str">
        <el-input type="text" v-model="ruleForm.search_str" minlength="1" placeholder="请输入快手ID号"></el-input>
      </el-form-item>
      <el-form-item label="关注数量：" prop="to_num">
        <el-input-number
